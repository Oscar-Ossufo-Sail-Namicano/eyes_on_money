...
# (str) Package name
package.name = eyesonmoney

# (str) Package domain (needed for android/ios packaging)
package.domain = org.csm
...
requirements = python3,kivy==2.3.1,kivymd==1.2.0,filetype,pandas,KivyGradient==0.0.5,openpyxl,et_xmlfile,pillow
...
icon.filename = %(source.dir)s/images/small_simple_icon.png
